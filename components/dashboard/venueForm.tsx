...
export function VenueForm({
  ...
  function buildPayload(): VenueFormPayload {
    return {
      ...
      <div className="lg:col-span-1">
        <div className="sticky top-8 bg-white border border-gray-200 rounded-2xl p-6">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 disabled:opacity-50 text-black font-syne font-semibold py-3 rounded-xl text-sm transition-colors"
          >
            <Rocket size={16} />
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6">
      <div className="flex items-center gap-2.5 mb-5">
        ...
        {optional && <span className="font-dm text-xs text-gray-400 ml-1">(optional)</span>}
      </div>
      {children}
    </div>
  );
